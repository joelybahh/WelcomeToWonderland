...
/// </summary>
public class WW_ColourLightPuzzle : MonoBehaviour {

    [Header("Desired Color Settings")]
    [SerializeField] private NVRExampleRGBResult m_result;
    ...
    [Header("Hidden Text")]
    [SerializeField] private List<Text> m_redLightText;
    [SerializeField] private List<Text> m_greenLightText;
    [SerializeField] private List<Text> m_blueLightText;

    [Header("Room Light References")]
    [SerializeField] private GameObject m_mainRoomLight;
    ...
    private WW_Float3 m_rgb     = new WW_Float3(0.0f, 0.0f, 0.0f);     // stores 3 rgb floats representing the difference in colour
...
public class WW_Float3 {
    ...
    public WW_Float3(float a_rDiff, float a_gDiff, float a_bDiff) {
        rDiff = a_rDiff;
        gDiff = a_gDiff;
        bDiff = a_bDiff;
    }
