...
namespace WW.Puzzles {
    ...
    /// </summary>
    public class SpinnerPuzzle : Puzzle {

        [Header("Ring References")]
        [SerializeField]
        private NewtonVR.NVRLetterSpinner m_outerSpinner;
        [SerializeField]
        private NewtonVR.NVRLetterSpinner m_middleSpinner;
        [SerializeField]
        private NewtonVR.NVRLetterSpinner m_centerSpinner;

        [Header("Ring Rotation Settings")]
        [SerializeField]
        private float m_outerDesiredRot;
        [SerializeField]
        private float m_middleDesiredRot;
        [SerializeField]
        private float m_centerDesiredRot;
        ...
        [SerializeField]
        private Light m_blueLight;

        [Header("Button Reference")]
        [SerializeField]
        private NewtonVR.NVRButton m_button;
