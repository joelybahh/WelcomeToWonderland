...
namespace WW.AI {
    ...
    ///              agents themselves.
    /// </summary>
    public class WW_AIPathManager : MonoBehaviour {
        ...
        public Transform GetNextWaypoint( ref int a_currentTargetIndex, WW_WaterRobot.ePathingBehaviour a_behaviour, ref bool a_movingForward ) {
            switch ( a_behaviour ) {
                case WW_WaterRobot.ePathingBehaviour.LOOPING: {
                ...
                case WW_WaterRobot.ePathingBehaviour.PING_PONG: {
                ...
                case WW_WaterRobot.ePathingBehaviour.STOP_AT_END: {
                    a_movingForward = true;
