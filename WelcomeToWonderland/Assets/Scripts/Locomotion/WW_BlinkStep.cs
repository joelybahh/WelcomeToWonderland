...
public class WW_BlinkStep : MonoBehaviour {

    [Header("VR Settings")]
    [SerializeField] private Transform m_vrRigRef;
    [SerializeField] private VRBasicController m_leftContRef;
    [SerializeField] private VRBasicController m_rightContRef;

    [SerializeField] private LayerMask m_mask;

    [Header("Blink Direction Settings")]
    [SerializeField] private Transform m_directionRef;

    [Header("Distance Settings")]
    [SerializeField] private float m_blinkDistance;

    [Header("Blink Events")]
    [SerializeField] private UnityEvent m_onBlinkBegin;
    [SerializeField] private UnityEvent m_onBlinkEnd;

    [Header("Blink Button Settings")]
    [SerializeField] VRBasicController.ViveButton m_blinkButton = VRBasicController.ViveButton.TOUCHPAD;
